...
public class SubjectExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<String> expandableListTitle; // Contiene los nombres de todas las asignaturas
    private HashMap<String, ArrayList<String>> expandableListDetail; // Cada asignatura tiene una lista con el nombre de los grupos

    public SubjectExpandableListAdapter(ArrayList<String> expandableListTitle, HashMap<String, ArrayList<String>> expandableListDetail) {
