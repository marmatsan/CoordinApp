package com.elcazadordebaterias.coordinapp.fragments.studentfragments.home;
            ...
            if (task.isSuccessful()) {
                for (QueryDocumentSnapshot document : task.getResult()) {
                    ...
                    for(PetitionUser currentUser : currentPetition.getPetitionUsersList()){
                        participantsList.add(new PetitionGroupParticipantCard(currentUser.getUserFullName(), currentUser.getPetitionStatus()));
                    }
